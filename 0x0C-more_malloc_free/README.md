...
Tasks 0. Trust no one mandatory Write a function that allocates memory using malloc.
...
_realloc #advanced Write a function that reallocates a memory block using malloc and free
...
We must accept finite disappointment, but never lose infinite hope #advanced Write a program that multiplies two positive numbers.
